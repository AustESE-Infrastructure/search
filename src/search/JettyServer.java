...
public class JettyServer extends AbstractHandler
{
    ...
    public static String indexRoot = "/home/ecdosis/index";
        ...
        try
        {
            ...
            if ( service.equals(Service.SEARCH) )
            {
                ...
                if ( method.equals("GET") )
                    new SearchGetHandler().handle( request, response, urn );
                else if ( method.equals("POST") )
                    new SearchPostHandler().handle( request, response, urn );
                else
                    throw new Exception("Unknown http method "+method);
            }
            else if ( !service.equals("favicon.ico"))
